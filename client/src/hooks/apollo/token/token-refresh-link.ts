/* 
    Inspired by https://github.com/newsiberian/apollo-link-token-refresh

    Added directly because of type issues with the original.
*/
...
const throwServerError = (response: Response, result: Record<string, any>, message: string | undefined) => {
